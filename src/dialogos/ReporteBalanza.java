...
public class ReporteBalanza extends javax.swing.JDialog {
    private int mes, año;
    ...
    public ReporteBalanza(java.awt.Frame parent, boolean modal) {
        super(parent, "Balanza Comprobacion",modal);
        initComponents();
    }
    
    public ReporteBalanza(java.awt.Frame parent, boolean modal, int mes, int año) {
        super(parent, "Balanza Comprobacion",modal);
        initComponents();
        lblTitulo.setText(lblTitulo.getText() + ": " + mes + "/" + año);
        this.mes = mes;
        this.año = año;
        llenarTabla();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("BALANZA DE COMPROBACIÓN DE ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 578, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        try {
            ...
            reporte.generarReporte("D:\\TAREAS\\TAREAS TEC\\SEMESTRE 4\\TOPICOS AVANZADOS\\PROYECTO\\Scofain\\src\\balanza\\Balanza" + mes + "" + año + ".pdf", "Balanza", "balanza", listaconsulta);
                //
                new Procesos().cargarArchivoB("Balanza" + mes + "" + año);
            } catch (Exception e) {
    ...
    private void llenarTabla(){
        ...
        try {
            ...
            listaconsulta = consultaDao.consulta2(mes, año);
            ...
            for(Consultas lista: listaconsulta){
                datosllenado[0] = lista.getCuenta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteBalanza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteBalanza dialog = new ReporteBalanza(new javax.swing.JFrame(), true);
